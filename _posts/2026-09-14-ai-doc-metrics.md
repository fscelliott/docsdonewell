---
title: Metrics and evals for AI-generated docs
---
...
- For me, the point of wordsmithing is to get to a point that the agent CANNOT misinterpret your writing (you want to leave no room for them to hallucinate an explanation)
...
- Try out Claude tag in Slack
- A nice vision: 'self-healing' docs; auto bots that check drift btwn code and docs
- I'm not sure if this was in the podcast or if I extrapolated, but: try adding 'related topics/keywords' to YAML frontmatter; nice to embed knowledge in docs metadata at the source rather than in skills "
- Mintflfly now lets you see all the anoymous chats readers had w/ your serach box AI in docs; my research shows you can also achieve that with other 3rd-party AI chatbots (I think doc goblin got there with 
