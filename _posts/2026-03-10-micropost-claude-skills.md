...
- The AI docs-authoring toolchain I've built out for my client Sensible is pretty extensive at this point -- my `.claude`  dir is full of docs-writing skills, preferences, style guides, and templates. And the crazy thing is, they really do seem to work well! I'm growing and changing the infrastructure fast -- this snapshot will probably be out of date in half a week:
