...
- Claude's plugins are amazing! Especially the official `/skill-creator` and `/code-simplifier` plugins. I need to check out `brainstorming`, next.
...
- The AI docs-authoring toolchain I've built out is pretty extensive at this point -- my `.claude`  dir is full of docs-writing skills, preferences, style guides, and templates. And the crazy thing is, they really do seem to work well!
