...
- **Question**: Will the transition from MD to MDX respect all my markup tags?
  - **Answer**: I've noticed all my formatting tags are respected, whew!  In particular I noticed that the conversion presreved my `<br/>` tags, for example -- hugely important for some of my reference topic formatting, and something not all MD to MDX conversions respect.
