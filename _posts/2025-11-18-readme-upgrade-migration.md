...
- **Question**: Will any of my markup tags get stripped in the conversion from MD to MDX?
  - **Answer:** I've noticed all my formatting tags are respected, whew!  In particular I noticed that the conversion presreved my `<br/>` tags in tables, for example -- hugely important for some of my reference topic formatting, and not a given for MD to MDX conversions.
